  ...
  return (
    <div className="w-full max-w-md relative z-10 transition-all duration-300 animate-in fade-in slide-in-from-bottom-8">
      <div className="text-center mb-10">
        ...
        <h1 className="text-4xl font-bold tracking-tight mb-2 text-gradient-gold">{translate("Join Tinobot")}</h1>
        <p className="text-muted-foreground font-medium opacity-80">{translate("Register for secure API access")}</p>
      </div>
      ...
      <Card className="p-8 shadow-2xl border-primary/10 bg-card/50 backdrop-blur-xl">
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <Input
            ...
            type="text"
            placeholder={translate("How should we call you?")}
          ...
          <Input
            ...
            type="password"
            placeholder={translate("Choose a strong password")}
            inputClassName="h-12 font-bold text-[10px] tracking-widest"
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[20%] right-[20%] size-96 bg-primary/10 blur-[150px] rounded-full animate-pulse" />
        <div className="absolute bottom-[20%] left-[20%] size-96 bg-primary/5 blur-[150px] rounded-full" />
      </div>
